...
var CytoscapeComponent = React.createClass({
      ...
      componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.data !== this.props.data) {
          ...
          this.initializeCytoscape(nextProps.data,this.props.layout);
          //  this.cy.data = nextProps.data;
        }

      },
      initializeCytoscape(graphData,layout){
      ...
      componentDidMount() {
        var initialLayout='breadthfirst';
        this.initializeCytoscape(this.props.data,initialLayout);
